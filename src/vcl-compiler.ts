 ...
 * It transforms the abstract syntax tree (AST) generated by the parser into JavaScript functions
 * that can be executed at runtime to process HTTP requests according to VCL logic.
 */
 ...
 *
 * This object contains implementations of standard VCL functions that can be
 * called from VCL code. These functions provide core functionality like
 * logging, string manipulation, and time operations.
 */
...
export class VCLCompiler {
  ...
  /**
   * Compiles the VCL program into executable subroutines
   *
  ...
  /**
   * Compiles a VCL subroutine into an executable function
   *
   * @param subroutine - The VCL subroutine to compile
   * @param initialContext - Optional initial context to merge with the execution context
   * @returns A function that executes the subroutine with a given context
   */
  ...
  /**
   * Executes a VCL statement with the given context
   *
   * @param statement - The VCL statement to execute
   * @param context - The VCL context
   * @returns The return value of the statement, if any
   */
  ...
  /**
   * Executes an error statement, setting the error status and message in the context
   *
   * @param statement - The error statement to execute
   * @param context - The VCL context
  ...
  /**
   * Executes a log statement, logging the message to the console
   *
   * @param statement - The log statement to execute
   * @param context - The VCL context
   */
  ...
  /**
   * Executes a synthetic statement, setting the synthetic response in the context
   *
   * @param statement - The synthetic statement to execute
   * @param context - The VCL context
   */
  ...
  /**
   * Executes a hash_data statement, adding a hash of the value to the context's hashData array
   *
   * @param statement - The hash_data statement to execute
   * @param context - The VCL context
   */
  ...
  /**
   * Evaluates a VCL expression with the given context
   *
   * @param expression - The VCL expression to evaluate
   * @param context - The VCL context
  ...
  /**
   * Evaluates a ternary expression with the given context
   *
   * @param expression - The ternary expression to evaluate
   * @param context - The VCL context
   * @returns The evaluated value of either the true or false expression
   */
  ...
  /**
   * Evaluates a function call expression with the given context
   *
   * @param expression - The function call expression to evaluate
   * @param context - The VCL context
