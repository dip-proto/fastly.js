  ...
  tests: [
    ...
    },
    {
      ...
      assertions: [
        ...
        (context: VCLContext) => {
          return assert(
            context.req.http.Cookie && context.req.http.Cookie.includes('ab_test='),
      ...
      assertions: [
        ...
        (context: VCLContext) => {
          return assert(
            ...
            context.resp.http['Content-Security-Policy'].includes('default-src'),
