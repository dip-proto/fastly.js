...
function executeSubroutine(context: VCLContext, subroutines: VCLSubroutines, name: string): string {
    ...
    // Test 1: Load and execute multiple VCL files
    {
      ...
      assertions: [
        ...
        (context: VCLContext) => {
          ...
          return {success: true, message: 'Headers from both files are set correctly'};
        },
        ...
        (context: VCLContext) => {
          ...
          return {success: true, message: 'VCL code from both files was executed correctly'};
        }
      ]
    },
    ...
    // Test 2: Load VCL files with loadVCLContent
    {
      ...
      assertions: [
        ...
        (context: VCLContext) => {
          ...
          return {success: true, message: 'Subroutines from both files executed correctly'};
        }
      ]
    }
  ]
