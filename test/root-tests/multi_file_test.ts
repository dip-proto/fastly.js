...
if (context.req.http['X-Test-File-1'] !== 'File 1') {
  console.error('❌ Header X-Test-File-1 not set correctly');
  success = false;
} else {
  console.log('✅ Header X-Test-File-1 set correctly');
}

if (context.resp.http['X-Test-File-2'] !== 'File 2') {
  console.error('❌ Header X-Test-File-2 not set correctly');
  success = false;
} else {
  console.log('✅ Header X-Test-File-2 set correctly');
}
...
console.log('✅ VCL code from both files was executed correctly');
