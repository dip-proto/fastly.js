...
console.log(
	`User-Agent header: ${context.std.header.get(testHeaders, "User-Agent")}`,
);
console.log(
	`Non-existent header: ${context.std.header.get(testHeaders, "Non-Existent")}`,
);
console.log(
	`Case-insensitive test: ${context.std.header.get(testHeaders, "content-type")}`,
);
...
console.log(
	`After setting New-Header: ${context.std.header.get(testHeaders, "New-Header")}`,
);
console.log(
...
context.std.header.filter_except(
	filterExceptHeaders,
...
console.log(
	`200 matches "2xx": ${context.std.http.status_matches(200, "2xx")}`,
);
console.log(
	`200 matches "success": ${context.std.http.status_matches(200, "success")}`,
);
console.log(
	`200 matches "200": ${context.std.http.status_matches(200, "200")}`,
);
console.log(
	`200 matches "3xx": ${context.std.http.status_matches(200, "3xx")}`,
);

// Test with redirect status codes
console.log("\nRedirect status codes:");
console.log(
	`301 matches "3xx": ${context.std.http.status_matches(301, "3xx")}`,
);
console.log(
	`301 matches "redirect": ${context.std.http.status_matches(301, "redirect")}`,
);
console.log(
	`301 matches "301": ${context.std.http.status_matches(301, "301")}`,
);
console.log(
	`301 matches "2xx": ${context.std.http.status_matches(301, "2xx")}`,
);

// Test with client error status codes
console.log("\nClient error status codes:");
console.log(
	`404 matches "4xx": ${context.std.http.status_matches(404, "4xx")}`,
);
console.log(
	`404 matches "client_error": ${context.std.http.status_matches(404, "client_error")}`,
);
console.log(
	`404 matches "error": ${context.std.http.status_matches(404, "error")}`,
);
console.log(
	`404 matches "404": ${context.std.http.status_matches(404, "404")}`,
);

// Test with server error status codes
console.log("\nServer error status codes:");
console.log(
	`500 matches "5xx": ${context.std.http.status_matches(500, "5xx")}`,
);
console.log(
	`500 matches "server_error": ${context.std.http.status_matches(500, "server_error")}`,
);
console.log(
	`500 matches "error": ${context.std.http.status_matches(500, "error")}`,
);
console.log(
	`500 matches "500": ${context.std.http.status_matches(500, "500")}`,
);
