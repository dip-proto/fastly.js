...
console.log(`After updating X-Custom-Header: ${context.std.header.get(testHeaders, 'X-Custom-Header')}`);

// Test header.remove function
console.log('\n--- header.remove Tests ---');
console.log(`Before removal - X-Debug-Info: ${context.std.header.get(testHeaders, 'X-Debug-Info')}`);
context.std.header.remove(testHeaders, 'X-Debug-Info');
console.log(`After removal - X-Debug-Info: ${context.std.header.get(testHeaders, 'X-Debug-Info')}`);
...
console.log(`404 matches "client_error": ${context.std.http.status_matches(404, 'client_error')}`);
...
console.log(`500 matches "server_error": ${context.std.http.status_matches(500, 'server_error')}`);
