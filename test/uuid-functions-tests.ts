    ...
    // Test 1: UUID generation
    {
      ...
      assertions: [
        ...
        (context: VCLContext) => {
          ...
          return assert(
            context.req.http['X-UUID-V3'].match(/^[0-9a-f]{8}-[0-9a-f]{4}-3[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i),
        ...
        (context: VCLContext) => {
          ...
          return assert(
            context.req.http['X-UUID-V5'].match(/^[0-9a-f]{8}-[0-9a-f]{4}-5[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i),
        ...
        (context: VCLContext) => {
          ...
          return assert(
            context.req.http['X-UUID-DNS'].match(/^[0-9a-f]{8}-[0-9a-f]{4}-5[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i),
        ...
        (context: VCLContext) => {
          ...
          return assert(
            context.req.http['X-UUID-URL'].match(/^[0-9a-f]{8}-[0-9a-f]{4}-5[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i),
