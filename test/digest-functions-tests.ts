  ...
  tests: [
    // Test 1: Basic hash functions
    {
      ...
      assertions: [
        ...
        (context: VCLContext) => {
          return assert(
            context.req.http['X-SHA1'] === '0a4d55a8d778e5022fab701977c5d840bbc486d0',
        ...
        (context: VCLContext) => {
          return assert(
            context.req.http['X-SHA256'] === 'a591a6d40bf420404a011733cfb7b190d62c65bf0bcda32b57b277d9ad9f146e',
