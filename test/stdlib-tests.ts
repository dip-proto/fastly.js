  ...
  tests: [
    ...
    // Test 2: Time functions
    {
      ...
      assertions: [
        ...
        (context: VCLContext) => {
          return assert(
            !isNaN(parseInt(context.req.http['X-Now'])),
        ...
        (context: VCLContext) => {
          return assert(
            parseInt(context.req.http['X-Future']) > parseInt(context.req.http['X-Now']),
        ...
        (context: VCLContext) => {
          return assert(
            parseInt(context.req.http['X-Past']) < parseInt(context.req.http['X-Now']),
